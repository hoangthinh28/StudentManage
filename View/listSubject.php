...
//Search
$sql = "SELECT * from MonHocChuyenNganh order by NganhID DESC";
...
<body>
    ...
    <div class="container">
        <h2 style="text-align: center;">Danh Sách Môn Học Chuyên Ngành</h2>
        <table class="table">
            <tr>
                <th>MonHocID</th>
                <th>TenMonHoc</th>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td><a href="index.php?page_layout=updatesubject&subjectID=<?php echo $row['MonHocID']; ?>">Update</a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
